...
public class SslTrustUtils {
   ...
   * should only be used in development or when connecting to trusted endpoints with self-signed
   * certificates.
   *
  ...
  /**
   * Creates an SSLContext that trusts all certificates (including self-signed ones). WARNING: This
   * should only be used in development or when connecting to trusted endpoints with self-signed
   * certificates.
   *
  ...
  /**
   * Creates a HostnameVerifier that accepts all hostnames. WARNING: This should only be used in
   * development or when connecting to trusted endpoints.
   *
  ...
  /**
   * Installs the trust-all SSL context as the default SSL context for the JVM. WARNING: This
   * affects all SSL connections in the application. This should only be used when necessary for
