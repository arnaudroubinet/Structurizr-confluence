...
public interface ConfluenceApi {
  ...
  Uni<String> findContentByTitle(
      @QueryParam("title") String title, @QueryParam("spaceKey") String spaceKey);
  ...
  Uni<String> getPage(
      @PathParam("pageId") String pageId, @QueryParam("body-format") String bodyFormat);
  ...
  Uni<String> uploadAttachment(
      @PathParam("pageId") String pageId,
      @org.jboss.resteasy.reactive.PartType(MediaType.APPLICATION_OCTET_STREAM) byte[] file,
      @QueryParam("filename") String filename);

  @GET
  @Path("/rest/api/content/{attachmentId}")
  Uni<String> getAttachmentWithExtensions(
      @PathParam("attachmentId") String attachmentId, @QueryParam("expand") String expand);

  @GET
  @Path("/rest/api/content/{pageId}/child/attachment")
  Uni<String> getAttachments(
      @PathParam("pageId") String pageId, @QueryParam("filename") String filename);
}
