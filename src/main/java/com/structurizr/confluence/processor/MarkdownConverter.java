...
/**
 * Robust Markdown to HTML converter using flexmark-java with common extensions
 * (tables, strikethrough, task lists). The output HTML is then fed into the
 * HtmlToAdfConverter for ADF conversion and title extraction.
 */
