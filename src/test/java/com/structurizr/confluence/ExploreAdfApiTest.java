...
public class ExploreAdfApiTest {
    ...
    public void exploreDocumentMethods() {
        ...
        try {
            Document docWithLink = Document.create().fromMarkdown("[Documentation officielle](https://developer.atlassian.com)");
            ...
            if (docWithLink.children().size() > 0) {
                System.out.println("Premier enfant: " + docWithLink.children().get(0).getClass().getSimpleName());
            }
        } catch (Exception e) {
