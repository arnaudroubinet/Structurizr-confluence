...
public class AdfMethodBehaviorTest {
    ...
    public void testFromMarkdownVsParagraph() throws Exception {
        ...
        logger.info("Méthode paragraph() - Document final: {}", 
        ...
        logger.info("fromMarkdown multi-paragraphes - Document: {}", 
