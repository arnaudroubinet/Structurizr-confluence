...
/**
 * Integration test for SSL trust configuration. This demonstrates how the SSL bypass functionality
 * works in practice.
 */
  ...
  void testSslVerificationEnabledByDefault() {
    ...
    assertDoesNotThrow(
        () -> {
          var httpClient = SslTrustUtils.createTrustAllHttpClient();
          assertNotNull(
              httpClient, "HttpClient should be created successfully with default SSL settings");
