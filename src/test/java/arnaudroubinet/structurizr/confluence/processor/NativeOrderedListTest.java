...
public class NativeOrderedListTest {
  ...
  public void testSimpleOrderedListConversion() throws JsonProcessingException {
    ...
    String htmlContent =
        "<ol><li>Premier item</li><li>Deuxième item</li><li>Troisième item</li></ol>";
  ...
  public void testOrderedListWithInlineFormatting() throws JsonProcessingException {
    ...
    String htmlContent =
        "<ol><li>Item avec <strong>gras</strong></li><li>Item avec <em>italique</em></li><li>Item avec <code>code</code></li></ol>";
  ...
  public void testComparisonWithBulletList() throws JsonProcessingException {
    ...
    String orderedJson =
        objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(orderedDoc);
    ...
    assert orderedJson.contains("\"type\" : \"orderedList\"")
        : "Ordered list devrait avoir le type orderedList";
    assert bulletJson.contains("\"type\" : \"bulletList\"")
        : "Bullet list devrait avoir le type bulletList";

    // Vérifier que la structure des items est similaire
    assert orderedJson.contains("\"type\" : \"listItem\"")
        : "Ordered list devrait contenir des listItem";
    assert bulletJson.contains("\"type\" : \"listItem\"")
        : "Bullet list devrait contenir des listItem";
  }
}
