...
/**
 * Tests unitaires pour la résolution du titre de page (H1 prioritaire, puis fallback au nom de
 * fichier) en couvrant HTML et Markdown.
 */
class PageTitleResolutionTest {
  ...
  void html_with_whitespace_h1_falls_back() {
    ...
    String extracted = converter.extractPageTitleOnly(html);
    assertTrue(
        extracted == null || extracted.trim().isEmpty(), "Whitespace-only H1 must be ignored");
  }
