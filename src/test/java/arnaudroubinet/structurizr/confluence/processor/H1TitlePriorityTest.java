...
public class H1TitlePriorityTest {
    ...
    void testH1WithSpecialCharactersIsPreserved() {
        String htmlWithSpecialChars = "<h1>ADR 1 - Record architecture decisions</h1><p>Date: 2016-02-12</p>";
    ...
    void testH1WithNestedElementsIsExtracted() {
        String htmlWithNestedH1 = "<h1>Titre avec <strong>gras</strong> et <em>italique</em></h1><p>Contenu</p>";
