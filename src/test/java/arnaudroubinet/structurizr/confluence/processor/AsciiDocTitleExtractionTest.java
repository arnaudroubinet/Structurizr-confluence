...
/**
 * Test unitaire minimal pour vérifier qu'un H1 AsciiDoc ("= Title") est bien géré après conversion
 * en HTML par AsciiDocConverter.convertToHtml. NOTE: Ce test isole l'extraction titre/HTML en
 * simulant la sortie HTML attendue.
 */
