...
public class NativeBlockquoteTest {
  ...
  public void testSimpleBlockquoteConversion() throws JsonProcessingException {
    ...
    String htmlContent =
        "<blockquote><p>Ceci est une citation importante pour illustrer un point clé.</p></blockquote>";
    ...
    assert json.contains("Ceci est une citation importante")
        : "Devrait contenir le texte de la citation";
  }
  ...
  public void testBlockquoteWithInlineFormatting() throws JsonProcessingException {
    ...
    String htmlContent =
        "<blockquote><p>Citation avec <strong>texte important</strong> et <em>emphasis</em>.</p></blockquote>";
  ...
  public void testMultipleParagraphsInBlockquote() throws JsonProcessingException {
    ...
    String htmlContent =
        "<blockquote><p>Premier paragraphe de la citation.</p><p>Deuxième paragraphe avec plus de détails.</p></blockquote>";
  ...
  public void testSimpleTextBlockquote() throws JsonProcessingException {
    ...
    // Vérifier que le type est "blockquote"
    assert json.contains("\"type\" : \"blockquote\"") : "Le type devrait être blockquote";
    assert json.contains("Citation simple sans balise")
        : "Devrait contenir le texte de la citation";
  }
  ...
  public void testComparisonWithOldFormat() throws JsonProcessingException {
    ...
    String htmlContent =
        "<blockquote><p>Cette citation ne devrait plus avoir de préfixe manuel.</p></blockquote>";
    ...
    assert json.contains("Cette citation ne devrait plus")
        : "Devrait contenir le texte sans préfixe";
  }
}
