...
/**
 * Test de débogage pour analyser la conversion du contenu AsciiDoc vers ADF. Permet d'identifier
 * les problèmes de troncature ou de conversion.
 */
public class AsciiDocContentAnalysisTest {
  ...
  void analyzeIntroductionAndGoalsConversion() {
    ...
    String htmlContent =
        asciiDocConverter.convertToHtml(asciiDocContent, "01_introduction_and_goals");
