 ...
 *
 * <p>Ces tests vérifient que les liens HTML sont correctement convertis en structures ADF conformes
 * à la spécification officielle d'Atlassian.
 */
public class AdfLinkHandlingTest {
  ...
  public void testInlineLinkConversion() {
    String html =
        "<p>Consultez la <a href=\"https://developer.atlassian.com\">documentation officielle</a> pour plus d'informations.</p>";
    ...
    assertTrue(
        adfJson.contains("\"type\"") && adfJson.contains("\"text\""), "Le texte doit être présent");
    assertTrue(adfJson.contains("\"marks\""), "Les marques de lien doivent être présentes");
    assertTrue(
        adfJson.contains("\"type\"") && adfJson.contains("\"link\""),
        "Le type de marque doit être 'link'");
    assertTrue(
        adfJson.contains("\"href\"") && adfJson.contains("https://developer.atlassian.com"),
  ...
  public void testStandaloneLinkConversion() {
    ...
    assertTrue(
        adfJson.contains("\"type\"") && adfJson.contains("\"paragraph\""),
        "Doit être dans un paragraphe");
    assertTrue(
        adfJson.contains("\"type\"") && adfJson.contains("\"text\""), "Le texte doit être présent");
    assertTrue(adfJson.contains("\"marks\""), "Les marques de lien doivent être présentes");
    assertTrue(
    ...
    assertTrue(
        adfJson.contains("Site officiel de Structurizr"), "Le texte du lien doit être préservé");
  }

  @Test
  public void testMultipleLinksInParagraph() {
    String html =
        "<p>Voir <a href=\"https://atlassian.com\">Atlassian</a> et <a href=\"https://structurizr.com\">Structurizr</a> pour plus d'infos.</p>";
  ...
  public void testLinkWithEmptyHref() {
    ...
    assertFalse(
        adfJson.contains("\"type\"") && adfJson.contains("\"link\""),
        "Ne doit pas contenir de marque de lien");
  }
