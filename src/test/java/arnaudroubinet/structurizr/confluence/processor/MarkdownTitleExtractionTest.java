...
/**
 * Tests unitaires pour vérifier l'extraction de titre à partir de contenu Markdown après conversion
 * simple vers HTML (simulateur minimal du convertisseur Markdown basique).
 */
