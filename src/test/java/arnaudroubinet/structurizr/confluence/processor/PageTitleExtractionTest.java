...
class PageTitleExtractionTest {
  ...
  void testExtractTitleFromFirstH1() {
    ...
    String htmlWithH1 =
        "<h1>Architecture Overview</h1><p>This document describes the architecture.</p><h2>Section 1</h2><p>Content here.</p>";
  ...
  void testNoH1InContent() {
    ...
    // HTML sans H1
    String htmlWithoutH1 =
        "<p>This document has no title.</p><h2>Section 1</h2><p>Content here.</p>";
  ...
  void testMultipleH1OnlyFirstExtracted() {
    ...
    String htmlWithMultipleH1 =
        "<h1>Main Title</h1><p>Content</p><h1>Another Title</h1><p>More content</p>";
