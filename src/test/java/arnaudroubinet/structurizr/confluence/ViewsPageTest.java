...
/**
 * Test for Views page document building logic. This test verifies that the document combination
 * logic works correctly for building up the Views page with multiple diagrams.
 */
public class ViewsPageTest {
  ...
  public void testCombineDocuments() throws Exception {
    ...
    Document addDoc = Document.create().paragraph("Test paragraph 1");
    ...
    assertTrue(
        combinedJson.contains("Test paragraph 1"),
  ...
  public void testCombineMultipleDocumentsInLoop() throws Exception {
    ...
    for (int i = 1; i <= 3; i++) {
      Document imgDoc = Document.create().paragraph("Diagram " + i);
