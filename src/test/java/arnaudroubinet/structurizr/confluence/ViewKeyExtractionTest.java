...
/**
 * Tests for the extractViewKeyFromFilename logic in ConfluenceExporter.
 * This test validates the filename parsing logic without requiring a full ConfluenceExporter instance.
 */
public class ViewKeyExtractionTest {
    ...
    public void testExtractComplexViewKey() {
        String viewKey = extractViewKeyFromFilename("structurizr-789-My-Complex-View-Name-With-Dashes.png");
